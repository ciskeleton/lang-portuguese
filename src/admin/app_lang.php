...
$lang['admin_install_update_confirm'] = 'Tem a certeza de que pretende atualizar este pacote?';
$lang['admin_install_update_error'] = 'Falha ao atualizar o pacote.';
$lang['admin_install_update_skip_confirm'] = 'Tem a certeza de que pretende ignorar esta atualização?';
...
$lang['admin_modules_delete_error_active'] = 'Os módulos ativos não podem ser eliminados.';
...
$lang['admin_modules_global'] = 'Módulo global (partilhado)';
$lang['admin_modules_install_confirm'] = 'Tem a certeza de que pretende instalar o módulo: <b>%s</b>?';
...
$lang['admin_modules_update_confirm'] = 'Tem a certeza de que pretende atualizar este módulo?';
...
$lang['admin_plugins_delete_error_active'] = 'Os plugins ativos não podem ser eliminados.';
...
$lang['admin_plugins_global'] = 'Plugin global (partilhado)';
$lang['admin_plugins_install_confirm'] = 'Tem a certeza de que pretende instalar o plugin: <b>%s</b>?';
...
$lang['admin_plugins_update_confirm'] = 'Tem a certeza de que pretende atualizar este plugin?';
...
$lang['admin_themes_install_confirm'] = 'Tem a certeza de que pretende instalar o tema: <b>%s</b>?';
...
$lang['admin_themes_update_confirm'] = 'Tem a certeza de que pretende atualizar este tema?';
...
$lang['admin_languages_delete_confirm'] = 'Tem a certeza de que pretende eliminar o idioma: <b>%s</b>?';
$lang['admin_languages_delete_error'] = 'Falha ao eliminar o idioma.';
$lang['admin_languages_delete_error_active'] = 'Os idiomas ativos não podem ser eliminados.';
$lang['admin_languages_delete_error_default'] = 'O idioma predefinido não pode ser eliminado.';
$lang['admin_languages_delete_success'] = 'Idioma eliminado com sucesso.';
...
$lang['admin_languages_install_confirm'] = 'Tem a certeza de que pretende instalar o idioma: <b>%s</b>?';
...
$lang['admin_languages_update_confirm'] = 'Tem a certeza de que pretende atualizar este idioma?';
...
$lang['package_archive_download_failed'] = 'Falha ao descarregar o arquivo do pacote.';
$lang['package_backup_create_error'] = 'Falha ao criar a cópia de segurança do pacote.';
$lang['package_backup_dir_failed'] = 'Falha ao criar o diretório de cópia de segurança %s';
$lang['package_backup_missing'] = 'O ficheiro de cópia de segurança não existe.';
$lang['package_backup_path_error'] = 'Não foi possível resolver o caminho do ficheiro de cópia de segurança.';
$lang['package_backup_request_invalid'] = 'Pedido de cópia de segurança inválido.';
$lang['package_backup_restore_error'] = 'Falha ao restaurar a cópia de segurança do pacote.';
$lang['package_catalog_type_unknown'] = 'Tipo de catálogo desconhecido.';
$lang['package_checksum_error'] = 'A verificação da soma de controlo (checksum) do pacote falhou.';
$lang['package_copy_files_error'] = 'Falha ao copiar os ficheiros do pacote para o destino.';
$lang['package_copy_updates_error'] = 'Falha ao copiar os ficheiros de atualização para o destino.';
...
$lang['package_download_dir_failed'] = 'Falha ao criar o diretório de transferência %s';
$lang['package_download_empty'] = 'O descarregamento do pacote devolveu uma resposta vazia.';
$lang['package_download_request_invalid'] = 'Pedido de descarregamento do pacote inválido.';
$lang['package_extract_failed'] = 'Falha ao extrair o ZIP %s';
$lang['package_invalid_lang_files'] = 'Idioma inválido — ficheiros de idioma obrigatórios da aplicação em falta.';
$lang['package_invalid_lang_structure'] = 'Idioma inválido — diretórios admin e/ou ci3 em falta.';
$lang['package_invalid_missing_info'] = '%s inválido: falta "info.php".';
$lang['package_invalid_module_structure'] = 'Módulo inválido — diretórios config e/ou controllers obrigatórios em falta.';
$lang['package_invalid_plugin_boot'] = 'Plugin inválido — ficheiro "boot.php" em falta.';
$lang['package_invalid_plugin_contents'] = 'Plugin inválido — os plugins não podem conter controladores ou vistas (views).';
$lang['package_invalid_theme_boot'] = 'Tema inválido — ficheiro "boot.php" em falta.';
$lang['package_invalid_theme_views'] = 'Tema inválido — diretório views em falta.';
$lang['package_no_root_dir'] = 'O pacote não contém um diretório raiz.';
$lang['package_not_downloadable'] = 'O pacote não está disponível para descarregamento público.';
$lang['package_not_in_registry'] = 'O pacote não está disponível no registo público.';
$lang['package_request_invalid'] = 'Pedido de pacote inválido.';
$lang['package_rollback_request_invalid'] = 'Pedido de reversão (rollback) inválido.';
...
$lang['package_system_core_restricted'] = 'Os componentes do sistema não podem ser instalados como pacotes.';
...
$lang['package_update_request_invalid'] = 'Pedido de atualização de pacote inválido.';
$lang['package_update_root_mismatch'] = 'A raiz do arquivo de atualização não corresponde a %s.';
$lang['package_upload_dir_failed'] = 'Falha ao criar o diretório de carregamento %s';
$lang['package_url_invalid'] = 'URL de distribuição do pacote inválido.';
$lang['package_write_failed'] = 'Falha ao escrever o pacote em %s';
$lang['package_zip_not_found'] = 'O ficheiro ZIP do pacote não existe: %s';
...
$lang['update_rollback_confirm'] = 'Tem a certeza de que pretende restaurar a versão anterior?';
